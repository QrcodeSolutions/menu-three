let left = document.getElementsByClassName('bi-arrow-left-short')[0]
let right = document.getElementsByClassName('bi-arrow-right-short')[0]
...
let price_cont = document.getElementById('price-cont');
